	...
	namespace Api
	{
		namespace Types
		{
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetActualCount () const
					{
						return m_Response.GetLongLong("actualCount");
					}
			/// <summary>
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetDoneCount () const
					{
						return m_Response.GetLongLong("doneCount");
					}
			/// <summary>
			/// The number of errors encountered whilst running the Module or Script for players
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetErrorCount () const
					{
						return m_Response.GetLongLong("errorCount");
					}
			/// <summary>
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetBaseCurrency1Cost () const
					{
						return m_Response.GetLongLong("baseCurrency1Cost");
					}
			/// <summary>
			/// The Base Currency2 cost of the Virtual Good, before segmentation
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetBaseCurrency2Cost () const
					{
						return m_Response.GetLongLong("baseCurrency2Cost");
					}
			/// <summary>
			/// The Base Currency3 cost of the Virtual Good, before segmentation
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetBaseCurrency3Cost () const
					{
						return m_Response.GetLongLong("baseCurrency3Cost");
					}
			/// <summary>
			/// The Base Currency4 cost of the Virtual Good, before segmentation
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetBaseCurrency4Cost () const
					{
						return m_Response.GetLongLong("baseCurrency4Cost");
					}
			/// <summary>
			/// The Base Currency5 cost of the Virtual Good, before segmentation
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetBaseCurrency5Cost () const
					{
						return m_Response.GetLongLong("baseCurrency5Cost");
					}
			/// <summary>
			/// The Base Currency6 cost of the Virtual Good, before segmentation
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetBaseCurrency6Cost () const
					{
						return m_Response.GetLongLong("baseCurrency6Cost");
					}
			/// <summary>
			/// The Base currency costs of the Virtual Good, before experiments
			/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetBaseCurrencyCosts () const
					{
						return m_Response.GetGSDataObject("baseCurrencyCosts");
					}
			/// <summary>
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency1Cost () const
					{
						return m_Response.GetLongLong("currency1Cost");
					}
			/// <summary>
			/// The Currency2 cost of the Virtual Good
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency2Cost () const
					{
						return m_Response.GetLongLong("currency2Cost");
					}
			/// <summary>
			/// The Currency3 cost of the Virtual Good
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency3Cost () const
					{
						return m_Response.GetLongLong("currency3Cost");
					}
			/// <summary>
			/// The Currency4 cost of the Virtual Good
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency4Cost () const
					{
						return m_Response.GetLongLong("currency4Cost");
					}
			/// <summary>
			/// The Currency5 cost of the Virtual Good
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency5Cost () const
					{
						return m_Response.GetLongLong("currency5Cost");
					}
			/// <summary>
			/// The Currency6 cost of the Virtual Good
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency6Cost () const
					{
						return m_Response.GetLongLong("currency6Cost");
					}
			/// <summary>
			/// The currency costs of the Virtual Good
			/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetCurrencyCosts () const
					{
						return m_Response.GetGSDataObject("currencyCosts");
					}
			/// <summary>
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetMaxQuantity () const
					{
						return m_Response.GetLongLong("maxQuantity");
					}
			/// <summary>
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSegmentedCurrency1Cost () const
					{
						return m_Response.GetLongLong("segmentedCurrency1Cost");
					}
			/// <summary>
			/// The Segmented Currency2 cost of the Virtual Good, before experiments
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSegmentedCurrency2Cost () const
					{
						return m_Response.GetLongLong("segmentedCurrency2Cost");
					}
			/// <summary>
			/// The Segmented Currency3 cost of the Virtual Good, before experiments
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSegmentedCurrency3Cost () const
					{
						return m_Response.GetLongLong("segmentedCurrency3Cost");
					}
			/// <summary>
			/// The Segmented Currency4 cost of the Virtual Good, before experiments
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSegmentedCurrency4Cost () const
					{
						return m_Response.GetLongLong("segmentedCurrency4Cost");
					}
			/// <summary>
			/// The Segmented Currency5 cost of the Virtual Good, before experiments
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSegmentedCurrency5Cost () const
					{
						return m_Response.GetLongLong("segmentedCurrency5Cost");
					}
			/// <summary>
			/// The Segmented Currency6 cost of the Virtual Good, before experiments
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSegmentedCurrency6Cost () const
					{
						return m_Response.GetLongLong("segmentedCurrency6Cost");
					}
			/// <summary>
			/// The segmented currency costs of the Virtual Good, before experiments
			/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetSegmentedCurrencyCosts () const
					{
						return m_Response.GetGSDataObject("segmentedCurrencyCosts");
					}
			/// <summary>
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetQuantity () const
					{
						return m_Response.GetLongLong("quantity");
					}
			/// <summary>
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetAmount () const
					{
						return m_Response.GetLongLong("amount");
					}
			/// <summary>
			/// The quantity the player possesses after the transaction completed
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetNewValue () const
					{
						return m_Response.GetLongLong("newValue");
					}
			/// <summary>
			/// The type of item
			/// </summary>
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency1Wager () const
					{
						return m_Response.GetLongLong("currency1Wager");
					}
			/// <summary>
			/// The amount of type 2 currency that has been wagered on this challenge.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency2Wager () const
					{
						return m_Response.GetLongLong("currency2Wager");
					}
			/// <summary>
			/// The amount of type 3 currency that has been wagered on this challenge.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency3Wager () const
					{
						return m_Response.GetLongLong("currency3Wager");
					}
			/// <summary>
			/// The amount of type 4 currency that has been wagered on this challenge.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency4Wager () const
					{
						return m_Response.GetLongLong("currency4Wager");
					}
			/// <summary>
			/// The amount of type 5 currency that has been wagered on this challenge.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency5Wager () const
					{
						return m_Response.GetLongLong("currency5Wager");
					}
			/// <summary>
			/// The amount of type 6 currency that has been wagered on this challenge.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetCurrency6Wager () const
					{
						return m_Response.GetLongLong("currency6Wager");
					}
			/// <summary>
			/// An object representing the currencies that have been wagered on this challenge.
			/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetCurrencyWagers () const
					{
						return m_Response.GetGSDataObject("currencyWagers");
					}
			/// <summary>
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetMaxTurns () const
					{
						return m_Response.GetLongLong("maxTurns");
					}
			/// <summary>
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetRank () const
					{
						return m_Response.GetLongLong("rank");
					}
			/// <summary>
			...
			*/
			...
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetGlobalCount () const
					{
						return m_Response.GetLongLong("globalCount");
					}
			/// <summary>
			/// The Global Rank of the player in this leaderboard before the score was submitted.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetGlobalFrom () const
					{
						return m_Response.GetLongLong("globalFrom");
					}
			/// <summary>
			/// The old global rank of the player as a percentage of the total number of scores in this leaderboard .
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetGlobalFromPercent () const
					{
						return m_Response.GetLongLong("globalFromPercent");
					}
			/// <summary>
			/// The Global Rank of the player in this leaderboard after the score was submitted.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetGlobalTo () const
					{
						return m_Response.GetLongLong("globalTo");
					}
			/// <summary>
			/// The new global rank of the player as a percentage of the total number of scores in this leaderboard .
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetGlobalToPercent () const
					{
						return m_Response.GetLongLong("globalToPercent");
					}
			/// <summary>
			/// The number of friend entries the player has in this leaderboard.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSocialCount () const
					{
						return m_Response.GetLongLong("socialCount");
					}
			/// <summary>
			/// The Social Rank of the player in this leaderboard before the score was submitted.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSocialFrom () const
					{
						return m_Response.GetLongLong("socialFrom");
					}
			/// <summary>
			/// The old social rank of the player as a percentage of the total number of friend scores in this leaderboard.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSocialFromPercent () const
					{
						return m_Response.GetLongLong("socialFromPercent");
					}
			/// <summary>
			/// The Social Rank of the player in this leaderboard after the score was submitted.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSocialTo () const
					{
						return m_Response.GetLongLong("socialTo");
					}
			/// <summary>
			/// The old global rank of the player as a percentage of the total number of friend scores in this leaderboard.
			/// </summary>
					// method type 4
					Optional::t_LongLongOptional GetSocialToPercent () const
					{
						return m_Response.GetLongLong("socialToPercent");
					}
			/// <summary>
