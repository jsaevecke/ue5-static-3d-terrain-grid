	...
	namespace Api
	{
		namespace Requests
		{
			...
			*/
			...
			/// </summary>
			AmazonConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			/// <summary>
			...
			*/
			...
			/// </summary>
			AroundMeLeaderboardRequest& SetEntryCount( int entryCount )
			{
			...
			/// </summary>
			AroundMeLeaderboardRequest& SetIncludeFirst( int includeFirst )
			{
			...
			/// </summary>
			AroundMeLeaderboardRequest& SetIncludeLast( int includeLast )
			{
			...
			*/
			...
			/// </summary>
			BuyVirtualGoodsRequest& SetCurrencyShortCode( const gsstl::string& currencyShortCode )
			{
				m_Request.AddString("currencyShortCode", currencyShortCode);
				return *this;
			}
			/// <summary>
			/// Which virtual currency to use. (1 to 6)
			/// </summary>
			BuyVirtualGoodsRequest& SetCurrencyType( int currencyType )
			{
			...
			/// </summary>
			BuyVirtualGoodsRequest& SetQuantity( long long quantity )
			{
			...
			*/
			...
			/// </summary>
			ConsumeVirtualGoodRequest& SetQuantity( long long quantity )
			{
				m_Request.AddNumber("quantity", quantity);
				return *this;
			}
			...
			*/
			...
			/// </summary>
			CreateChallengeRequest& SetCurrency1Wager( long long currency1Wager )
			{
			...
			/// </summary>
			CreateChallengeRequest& SetCurrency2Wager( long long currency2Wager )
			{
			...
			/// </summary>
			CreateChallengeRequest& SetCurrency3Wager( long long currency3Wager )
			{
			...
			/// </summary>
			CreateChallengeRequest& SetCurrency4Wager( long long currency4Wager )
			{
			...
			/// </summary>
			CreateChallengeRequest& SetCurrency5Wager( long long currency5Wager )
			{
			...
			/// </summary>
			CreateChallengeRequest& SetCurrency6Wager( long long currency6Wager )
			{
			...
			/// </summary>
			CreateChallengeRequest& SetCurrencyWagers( const GameSparks::Core::GSRequestData& currencyWagers )
			{
				m_Request.AddObject("currencyWagers", currencyWagers);
				return *this;
			}
			/// <summary>
			...
			/// </summary>
			CreateChallengeRequest& SetMaxAttempts( long long maxAttempts )
			{
			...
			/// </summary>
			CreateChallengeRequest& SetMaxPlayers( long long maxPlayers )
			{
			...
			/// </summary>
			CreateChallengeRequest& SetMinPlayers( long long minPlayers )
			{
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			FacebookConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// </summary>
			FindChallengeRequest& SetCount( int count )
			{
			...
			/// </summary>
			FindChallengeRequest& SetOffset( int offset )
			{
			...
			*/
			...
			/// </summary>
			FindMatchRequest& SetSkill( long long skill )
			{
			...
			*/
			...
			/// </summary>
			FindPendingMatchesRequest& SetMaxMatchesToFind( int maxMatchesToFind )
			{
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			GameCenterConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			/// </summary>
			GameCenterConnectRequest& SetTimestamp( long long timestamp )
			{
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			GooglePlayConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			GooglePlusConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			KongregateConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// The number of items to return in a page (default=50)
			/// </summary>
			LeaderboardDataRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// Number of entries to include from head of the list
			/// </summary>
			LeaderboardDataRequest& SetIncludeFirst( int includeFirst )
			{
				m_Request.AddNumber("includeFirst", includeFirst);
				return *this;
			}
			...
			/// Number of entries to include from tail of the list
			/// </summary>
			LeaderboardDataRequest& SetIncludeLast( int includeLast )
			{
				m_Request.AddNumber("includeLast", includeLast);
				return *this;
			}
			...
			/// </summary>
			LeaderboardDataRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			/// The number of items to return in a page (default=50)
			/// </summary>
			ListChallengeRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// </summary>
			ListChallengeRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			/// The number of items to return in a page (default=50)
			/// </summary>
			ListMessageDetailRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// The offset (page number) to start from (default=0)
			/// </summary>
			ListMessageDetailRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			/// The number of items to return in a page (default=50)
			/// </summary>
			ListMessageRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// The offset (page number) to start from (default=0)
			/// </summary>
			ListMessageRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			/// The number of items to return in a page (default=50)
			/// </summary>
			ListMessageSummaryRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// The offset (page number) to start from (default=0)
			/// </summary>
			ListMessageSummaryRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			/// </summary>
			ListTeamChatRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// </summary>
			ListTeamChatRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			/// </summary>
			ListTeamsRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// The offset (page number) to start from (default=0)
			/// </summary>
			ListTeamsRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			/// The number of items to return in a page (default=50)
			/// </summary>
			ListTransactionsRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// The offset (page number) to start from (default=0)
			/// </summary>
			ListTransactionsRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			public:
				...
				LogChallengeEventRequest& SetEventAttribute(const gsstl::string& key, long long value)
				{
				...
				LogChallengeEventRequest& SetEventAttribute(const gsstl::string& key, const gsstl::vector<GameSparks::Core::GSData>& value)
				{
					m_Request.AddObjectList(key, value);
					return *this;
				}

				LogChallengeEventRequest& SetEventAttribute(const gsstl::string& key, const gsstl::vector<gsstl::string>& value)
				{
					m_Request.AddStringList(key, value);
					return *this;
				}

				LogChallengeEventRequest& SetEventAttribute(const gsstl::string& key, const gsstl::vector<long long>& value)
				{
					m_Request.AddNumberList(key, value);
					return *this;
				}

				LogChallengeEventRequest& SetEventAttribute(const gsstl::string& key, const gsstl::vector<int>& value)
				{
					m_Request.AddNumberList(key, value);
					return *this;
				}
			...
			*/
			...
			public:
				...
				LogEventRequest& SetEventAttribute(const gsstl::string& key, const gsstl::vector<GameSparks::Core::GSData>& value)
				{
					m_Request.AddObjectList(key, value);
					return *this;
				}

				LogEventRequest& SetEventAttribute(const gsstl::string& key, const gsstl::vector<gsstl::string>& value)
				{
					m_Request.AddStringList(key, value);
					return *this;
				}

				LogEventRequest& SetEventAttribute(const gsstl::string& key, const gsstl::vector<long long>& value)
				{
					m_Request.AddNumberList(key, value);
					return *this;
				}

				LogEventRequest& SetEventAttribute(const gsstl::string& key, const gsstl::vector<int>& value)
				{
					m_Request.AddNumberList(key, value);
					return *this;
				}
			...
			*/
			...
			/// The skill of the player looking for a match
			/// </summary>
			MatchmakingRequest& SetSkill( long long skill )
			{
				m_Request.AddNumber("skill", skill);
				return *this;
			}
			...
			*/
			class NXConnectRequest : public GameSparks::Core::GSTypedRequest < NXConnectRequest, GameSparks::Api::Responses::AuthenticationResponse >
			{
			public:
				NXConnectRequest(Core::GS& gsInstance)
					: GSTypedRequest(gsInstance, ".NXConnectRequest")
				{
			...
			/// </summary>
			NXConnectRequest& SetAccountPerLoginId( bool accountPerLoginId )
			{
				m_Request.AddBoolean("accountPerLoginId", accountPerLoginId);
				return *this;
			}
			/// <summary>
			...
			/// </summary>
			NXConnectRequest& SetDisplayName( const gsstl::string& displayName )
			{
				m_Request.AddString("displayName", displayName);
				return *this;
			}
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			NXConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			/// Indicates that the server should not try to link the external profile with the current player.  If false, links the external profile to the currently signed in player.  If true, creates a new player and links the external profile to them.  Defaults to false.
			/// </summary>
			NXConnectRequest& SetDoNotLinkToCurrentPlayer( bool doNotLinkToCurrentPlayer )
			{
				m_Request.AddBoolean("doNotLinkToCurrentPlayer", doNotLinkToCurrentPlayer);
				return *this;
			}
			...
			/// Indicates whether the server should return an error if an account switch would have occurred, rather than switching automatically.  Defaults to false.
			/// </summary>
			NXConnectRequest& SetErrorOnSwitch( bool errorOnSwitch )
			{
				m_Request.AddBoolean("errorOnSwitch", errorOnSwitch);
				return *this;
			}
			...
			/// </summary>
			NXConnectRequest& SetNsaIdToken( const gsstl::string& nsaIdToken )
			{
				m_Request.AddString("nsaIdToken", nsaIdToken);
				return *this;
			}
			/// <summary>
			/// An optional segment configuration for this request.
			/// If this request creates a new player on the gamesparks platform, the segments of the new player will match the values provided
			/// </summary>
			NXConnectRequest& SetSegments( const GameSparks::Core::GSRequestData& segments )
			{
				m_Request.AddObject("segments", segments);
				return *this;
			}
			...
			/// Indicates that the server should switch to the supplied profile if it isalready associated to a player. Defaults to false.
			/// </summary>
			NXConnectRequest& SetSwitchIfPossible( bool switchIfPossible )
			{
				m_Request.AddBoolean("switchIfPossible", switchIfPossible);
				return *this;
			}
			...
			/// Indicates that the associated players displayName should be kept in syn with this profile when it's updated by the external provider.
			/// </summary>
			NXConnectRequest& SetSyncDisplayName( bool syncDisplayName )
			{
				m_Request.AddBoolean("syncDisplayName", syncDisplayName);
				return *this;
			}
			...
			*/
			class PSNAccountConnectRequest : public GameSparks::Core::GSTypedRequest < PSNAccountConnectRequest, GameSparks::Api::Responses::AuthenticationResponse >
			{
			public:
				PSNAccountConnectRequest(Core::GS& gsInstance)
					: GSTypedRequest(gsInstance, ".PSNAccountConnectRequest")
				{
			...
			/// </summary>
			PSNAccountConnectRequest& SetAuthorizationCode( const gsstl::string& authorizationCode )
			{
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			PSNAccountConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			/// Indicates that the server should not try to link the external profile with the current player.  If false, links the external profile to the currently signed in player.  If true, creates a new player and links the external profile to them.  Defaults to false.
			/// </summary>
			PSNAccountConnectRequest& SetDoNotLinkToCurrentPlayer( bool doNotLinkToCurrentPlayer )
			{
				m_Request.AddBoolean("doNotLinkToCurrentPlayer", doNotLinkToCurrentPlayer);
				return *this;
			}
			...
			/// Indicates whether the server should return an error if an account switch would have occurred, rather than switching automatically.  Defaults to false.
			/// </summary>
			PSNAccountConnectRequest& SetErrorOnSwitch( bool errorOnSwitch )
			{
				m_Request.AddBoolean("errorOnSwitch", errorOnSwitch);
				return *this;
			}
			...
			/// </summary>
			PSNAccountConnectRequest& SetRedirectUri( const gsstl::string& redirectUri )
			{
				m_Request.AddString("redirectUri", redirectUri);
				return *this;
			}
			...
			/// If this request creates a new player on the gamesparks platform, the segments of the new player will match the values provided
			/// </summary>
			PSNAccountConnectRequest& SetSegments( const GameSparks::Core::GSRequestData& segments )
			{
				m_Request.AddObject("segments", segments);
				return *this;
			}
			...
			/// Indicates that the server should switch to the supplied profile if it isalready associated to a player. Defaults to false.
			/// </summary>
			PSNAccountConnectRequest& SetSwitchIfPossible( bool switchIfPossible )
			{
				m_Request.AddBoolean("switchIfPossible", switchIfPossible);
				return *this;
			}
			...
			/// Indicates that the associated players displayName should be kept in syn with this profile when it's updated by the external provider.
			/// </summary>
			PSNAccountConnectRequest& SetSyncDisplayName( bool syncDisplayName )
			{
				m_Request.AddBoolean("syncDisplayName", syncDisplayName);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			PSNConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// </summary>
			PsnBuyGoodsRequest& SetUseCount( long long useCount )
			{
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			QQConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// The number of items to return in a page (default=50)
			/// </summary>
			SocialLeaderboardDataRequest& SetEntryCount( int entryCount )
			{
				m_Request.AddNumber("entryCount", entryCount);
				return *this;
			}
			...
			/// Number of entries to include from head of the list
			/// </summary>
			SocialLeaderboardDataRequest& SetIncludeFirst( int includeFirst )
			{
				m_Request.AddNumber("includeFirst", includeFirst);
				return *this;
			}
			...
			/// Number of entries to include from tail of the list
			/// </summary>
			SocialLeaderboardDataRequest& SetIncludeLast( int includeLast )
			{
				m_Request.AddNumber("includeLast", includeLast);
				return *this;
			}
			...
			/// The offset into the set of leaderboards returned
			/// </summary>
			SocialLeaderboardDataRequest& SetOffset( int offset )
			{
				m_Request.AddNumber("offset", offset);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			SteamConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			TwitchConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			TwitterConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			ViberConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			WeChatConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			XBOXLiveConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
			...
			*/
			...
			/// Indicates whether the server should return an error if a new player would have been registered, rather than creating the player.  Defaults to false.
			/// </summary>
			XboxOneConnectRequest& SetDoNotCreateNewPlayer( bool doNotCreateNewPlayer )
			{
				m_Request.AddBoolean("doNotCreateNewPlayer", doNotCreateNewPlayer);
				return *this;
			}
