		...
		class IGSPlatform
		{
			public:
					...
					, m_verboseLogging(verboseLogging)
				{
					...
					m_dontRetryAfterDisconnect = false;
				}
				...
				*/
				...
				bool GetDontRetryAfterDisconnect()
				{
					return m_dontRetryAfterDisconnect;
				}

				void SetDontRetryAfterDisconnect(bool value)
				{
					m_dontRetryAfterDisconnect = value;
				}
